...
symbols_connect_hooks (symctx_t symctx)
{
    ...
    static nametype_vectors_t symvec[6] = {
        { .typesize = sizeof(sym_literal_t),
          .typeinit = passthru_init,
          .typefree = passthru_free,
          .typecopy = passthru_copy,
          .typeser = litsym_serialize,
          .typedes = litsym_deserialize,
        },
        { .typesize = sizeof(sym_data_t),
          .typeinit = passthru_init,
          .typefree = data_free,
          .typecopy = data_copy,
          .typeser = datasym_serialize,
          .typedes = datasym_deserialize,
        },
        { .typesize = sizeof(sym_routine_t),
          .typeinit = passthru_init,
          .typefree = passthru_free,
          .typecopy = passthru_copy,
          .typeser = rtnsym_serialize,
          .typedes = rtnsym_deserialize,
        },
        { .typesize = sizeof(sym_module_t),
          .typeinit = passthru_init,
          .typefree = module_free,
          .typecopy = module_copy,
        },
        { .typesize = sizeof(sym_label_t),
          .typeinit = passthru_init,
          .typefree = passthru_free,
          .typecopy = passthru_copy,
        },
        { .typesize = sizeof(sym_psect_t),
          .typeinit = passthru_init,
          .typefree = psect_free,
          .typecopy = psect_copy,
        },
